...
def user_input_features():
    ...
    clase = st.number_input('Clase{Acapulco:0, Aguascalientes:1, Acuña:2}:', min_value=0, max_value=2, value=1, step=1)
    mes = st.number_input('mes:', min_value=1, max_value=12, value=1, step=1)
    año = st.number_input('año:', min_value=2000, max_value=2025, value=2020, step=1)
